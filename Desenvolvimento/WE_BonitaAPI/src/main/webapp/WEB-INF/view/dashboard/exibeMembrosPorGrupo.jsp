...
<div class="container" style="padding-top: 1.6%;">
	<div class="row">
		<div class="column">
			...
			<h7><i class="fa fa-bars"></i> Usuários</h7>
						...
						<tr>
							...
							<td>
								<c:if test="${usuario.managerUserId != 0}">
									<a href='<c:url value="/dashboard/gerente/${usuario.managerUserId}"></c:url>' title="Exiber gerente"><i class="fa fa-male"></i></a>
								</c:if>
								<c:if test="${usuario.managerUserId == 0}">
